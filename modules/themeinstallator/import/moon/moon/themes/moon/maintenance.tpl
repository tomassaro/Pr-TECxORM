...
{/if}
	...
	<body>
	 <div id="maintenance">
	  <ul> 
		<li><img src="{$base_dir}img/logo.gif" alt="logo" /></li>
		<p>{l s='In order to perform site maintenance, our online shop has been taken offline temporarily. We apologize for the inconvenience, and ask that you please try again later !'}
	    </p>
