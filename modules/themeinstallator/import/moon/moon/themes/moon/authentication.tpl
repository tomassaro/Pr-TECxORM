	...
	{if !isset($email_create)}
		<form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" id="create-account_form" class="std">
			<fieldset>
				...
				<p class="submit">
					<input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large" value="{l s='submit'}" />
		...
		<form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" id="login_form" class="std">
			<fieldset>
				...
				<p class="submit">
					...
					<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button" value="{l s='Connexion'}" />
				</p>
	...
	<form action="{$request_uri|escape:'htmlall':'UTF-8'|replace:'&amp;':'&'}" method="post" id="account-creation_form" class="std">
		...
		<fieldset>
			...
			<p class="required text" id="address_alias">
				<label for="alias">{l s='Address title'}</label>
		...
		<p class="cart_navigation required" id="submit">
