...
<div id="gift_div">
	<p>
	 ...
	 <label for="gift_cb">{l s='If you wish, you can add a note to the gift:'} {if $gift_wrapping_price > 0}({$gift_wrapping_price}&nbsp;euros){/if}</label>
	</p>
	<div class="clear"></div>
...
<p class="order_navigation">
 ...
 <a href="{$base_dir_ssl}order.php?step=1" title="{l s='Previous'}" class="buttonprecedent">{l s='Previous'}</a>
 <input type="submit" name="processCarrier" value="{l s='Next'}" class="buttonorder" />
</p>
</form>
{/if}
</div>
