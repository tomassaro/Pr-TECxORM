...
<div id="search_block_top">
	<form method="get" action="{$base_dir}search.php" id="searchbox">
		...
		<input type="text" id="search_query" name="search_query" value="{if isset($smarty.get.search_query)}{$smarty.get.search_query|htmlentities:$ENT_QUOTES:'utf-8'|stripslashes}{else}{l s='Search' mod='blocksearch'}{/if}" onfocus="javascript:if(this.value=='{l s='Search' mod='blocksearch'}')this.value='';" onblur="javascript:if(this.value=='')this.value='{l s='Search' mod='blocksearch'}';" />
