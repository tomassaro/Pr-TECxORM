...
<p>
	<img src="{$this_path}bankwire.gif" alt="{l s='bank wire' mod='bankwire'}" style="float:left; margin: 0px 10px 5px 0px;" />
...
<p class="order_navigation">
	<a href="{$base_dir_ssl}order.php?step=3" class="buttonnext">{l s='Other payment methods' mod='bankwire'}</a>
	<input type="submit" name="submit" value="{l s='I confirm my order' mod='bankwire'}" class="buttonconfimation" />
</p>
</form>
{/if}
</div>